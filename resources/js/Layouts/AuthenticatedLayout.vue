    ...
    <div>
        <div class="min-h-screen bg-gray-100">
                                        ...
                                        <span class="inline-flex rounded-md">
                                            <button type="button"
                                                ...
                                                <div class="w-8 h-8 mr-2 rounded-full overflow-hidden">
                                                    <img :src="$page.props.auth.user.photo"
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        <div class="px-4 flex items-center">
                            <div class="w-10 h-10 mr-2 rounded-full overflow-hidden">
                                <img :src="$page.props.auth.user.photo" class="w-full h-full object-cover">
                            </div>
                            <div>
            ...
            <header class="bg-white shadow" v-if="$slots.header">
                <div class="max-w-7xl mx-auto h-16 px-4 sm:px-6 lg:px-8 flex items-center">
                    <div class="flex-1">
                        <slot name="header" />
                    </div>
                </div>
